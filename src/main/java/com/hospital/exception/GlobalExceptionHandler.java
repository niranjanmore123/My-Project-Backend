...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> InvalidBookIdExceptionHandler(InvalidPatientIdException ex,WebRequest request)
    {
        HashMap<String, String> response=new HashMap<>();
    ...
    @ExceptionHandler(InvalidDoctorsIDException.class)
    public ResponseEntity<?> InvalidDoctorsIDExceptionHandler(InvalidDoctorsIDException ex,WebRequest request)
    {
        HashMap<String, String> response=new HashMap<>();
    ...
    @ExceptionHandler(InvalidDoctorsNameException.class)
    public ResponseEntity<?> InvalidDoctorsNameExceptionHandler(InvalidDoctorsNameException ex,WebRequest request)
    {
        HashMap<String, String> response=new HashMap<>();
    ...
    public ResponseEntity<?> InvalidPatientNameExceptionHandler(InvalidPatientNameException ex,WebRequest request)
    {
        HashMap<String, String> response=new HashMap<>();
